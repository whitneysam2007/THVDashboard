...
import {
  Users, Plane, BarChart2, CheckSquare, LogOut, Menu, X, ChevronRight, ShieldCheck, KeyRound, HeartHandshake, RefreshCw, Mail, Stethoscope, FolderOpen
} from 'lucide-react';
...
const NAV = [
  ...
  { href: '/tasks', label: 'Donor Tasks', icon: CheckSquare },
  ...
  { href: '/reports-resources', label: 'Reports & Resources', icon: FolderOpen },
